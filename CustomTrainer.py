...
class Trainer:
    ...
    def train(
        ...
        for epoch in range(epochs):
            ...
            if val_dataloader is not None:
                scores = self.evaluate(val_dataloader, str(the_text) + str(epoch))
                print('SCORES', scores)
    ...
    def evaluate(self, dataloader, text) -> Dict[str, float]:
        """Evaluates the model.
        ...
        if self.model.mode is not None:
            ...
            with open(f"/home/a053h213/PycharmProjects/EHRLLMGraph/MortalityPrediction/outputs_processed/y_true_{text}.pkl", "wb") as f:
                pickle.dump(y_true_all, f)
            with open(f"/home/a053h213/PycharmProjects/EHRLLMGraph/MortalityPrediction/outputs_processed/y_prob_{text}.pkl", "wb") as f:
